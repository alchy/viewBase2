...
- **Indikátor fokusu** — v liště hned **za textem titulku** svítí stylizované
  **oko** (jemná 1px linka, svisle v proporcích ostatních gadgetů) na okně,
  které je aktivní (patří mu Options i klávesnice); barvu bere z textu lišty.
