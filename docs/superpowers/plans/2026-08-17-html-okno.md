...
- [x] **Step 1: Napiš selhávající testy**
...
- [x] **Step 2: Spusť testy — musí selhat**
...
- [x] **Step 3: Implementuj `HtmlWindow` v `controls.py`**
...
- [x] **Step 4: Spusť testy — musí projít**
...
- [x] **Step 1: Přidej selhávající testy**
...
- [x] **Step 4: Spusť celou python sadu — musí projít**
...
- [x] **Step 1: Přidej selhávající test do `frontend/tests/themes.test.js`**
...
- [x] **Step 3: Implementuj `frontend/src/plugins/html_doc.js`**
...
- [x] **Step 1: Napiš selhávající DOM test**
...
- [x] **Step 3: Implementuj `frontend/src/plugins/html.js`**
...
- [x] **Step 4: Spusť celou frontend sadu — musí projít**
...
- [x] **Step 5: Ověř v prohlížeči (ruční kontrola, po Task 6 s ukázkou) a commit**
...
- [x] **Step 1: Napiš `examples/html_window.py`** (komentovaná ukázka ve stylu `examples/terminal.py`)
...
- [x] **Step 3: Build a ruční ověření v prohlížeči**
...
- [x] **Step 4: Celé testy + commit + push**
